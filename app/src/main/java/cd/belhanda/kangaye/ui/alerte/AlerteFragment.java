...
public class AlerteFragment extends Fragment implements EmisClick, RecusClick {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btnEmis = root.findViewById(R.id.btnAlertesEmis);

        btnRecus = root.findViewById(R.id.btnAlertesRecus);

        Emis = root.findViewById(R.id.recyclerEmis);
        Emis.setLayoutManager(new LinearLayoutManager(getActivity()));

        DatabaseReference reference;
        reference= FirebaseDatabase.getInstance().getReference("Users");
        reference = reference.child(key).child("Alertes").child("EMIS");
        ...
        Recus = root.findViewById(R.id.recycleRecus);
        ...
        references = references.child(key).child("Alertes").child("RECUS");
